...
"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
    ...
    <title>Ini Adalah Halaman Tambah Data</title>
  </head>
  <body>
    <div class="container">
...
<div class="container">
  <div class="row">
  <div class="col-6">
    <h1>ADD Product XI PPLG 2</h1>
    <div class="container"></div>
    <form method="post" action="/product" class="col-5">
      @csrf
  <div class="form-group">
    <label for="nama_produk">Nama Produk</label>
    <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" id="nama_produk" placeholder="masukkan nama produk" name="nama_produk">
    @error('nama_produk')
