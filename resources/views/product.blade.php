...
"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
    ...
    <title>Ini Adalah Halaman Produk</title>
  </head>
...
<div class="container">
    <h1>Daftar Product XI PPLG 2</h1>
</div>
<div class="container">
<a type="button" href="/product/create" class="btn btn-primary">add data</a>
</div>
...
<tr>
      ...
      <td>{{ $prd->harga }}</td>
      <td>
      <a type="button" href="/product/{{ $prd->id }}/edit" class="btn btn-success">Edit</a>
      <form action="/product/{{ $prd->id }}" method="post" class="d-inline">
        @csrf
        @method('delete')
        <button type="submit" class="btn btn-danger" data-id="{{ $prd->id }}"
        onclick="return confirm('want to delete this data?')">Delete</button>
      </form>
    </td>
 </tr>
 @endforeach
